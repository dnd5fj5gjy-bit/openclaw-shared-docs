...
We would welcome the Estate's consideration of substantially extending the term of the lease — for example, to around 60 years in total from the original Term Start Date — in exchange for fixing the Principal Rent at a set figure for the remainder of the extended term, with no further periodic rent reviews.
