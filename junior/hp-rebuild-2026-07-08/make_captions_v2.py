...
# 16-quizslow intentionally omitted — no caption over the questions so they stay readable
CAPS = {
    ...
    "14-results":   "The results page  ·  insights by body area, clear next steps",
    "15-supplements":"Supplement stack  ·  matched, reviewed, one-tap basket",
    "clinicalvalue":"The data does the clinical work  ·  safe prescribing off the quiz",
...
accent = (18, 179, 166, 255); box = (15, 42, 40, 232)
pad_x, pad_y, bar_w = 26, 16, 6
os.makedirs("captions-v2", exist_ok=True)
for sid, text in CAPS.items():
    img = Image.new("RGBA", (W, H), (0, 0, 0, 0)); d = ImageDraw.Draw(img)
    l, t, r, b = d.textbbox((0, 0), text, font=font)
    tw, th = r - l, b - t
    box_w = bar_w + pad_x + tw + pad_x; box_h = pad_y + th + pad_y
    x0, y0 = 64, H - 96 - box_h
    ...
    img.save(f"captions-v2/{sid}.png"); print("wrote", sid)
